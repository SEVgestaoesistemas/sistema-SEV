...
(() => {
  ...
  const pages = {
    ...
    relatorios: {
      ...
      content: `
        <section class="module-hero"><p class="eyebrow">Análises</p><h1>Relatórios</h1><p>Exporte os dados reais da sua empresa em Excel (XLSX) para conferência e análise.</p></section>
        <section class="reports-panel" aria-labelledby="reportsExportTitle">
          ...
          <div class="reports-grid">
            <article class="report-card"><span class="report-card-kicker">Comercial</span><h3>Vendas</h3><p>Pedidos, clientes, forma de pagamento, situação e total.</p><button class="secondary-button report-download" type="button" data-report="sales">Baixar Excel de vendas</button></article>
            <article class="report-card"><span class="report-card-kicker">Estoque</span><h3>Movimentações</h3><p>Entradas, saídas, ajustes e o saldo atual de cada produto.</p><button class="secondary-button report-download" type="button" data-report="stock">Baixar Excel de estoque</button></article>
            <article class="report-card"><span class="report-card-kicker">Financeiro</span><h3>Despesas</h3><p>Fornecedores, notas fiscais, vencimentos, valores e itens importados.</p><button class="secondary-button report-download" type="button" data-report="expenses">Baixar Excel de despesas</button></article>
            <article class="report-card"><span class="report-card-kicker">Financeiro</span><h3>Contas a receber</h3><p>Clientes, pedidos, vencimentos, recebimentos e situação.</p><button class="secondary-button report-download" type="button" data-report="receivables">Baixar Excel de contas</button></article>
          </div>
